          ...
          <v-col cols="12" sm="8" md="4">
            <ValidationObserver ref="obs" v-slot="{ invalid, validated, passes }">
              <v-card class="elevation-12">
                ...
                <v-card-text>
                  <v-form>
                    <ValidationProvider name="username" rules="required|max:10" v-slot="{ errors, valid }">
                      <v-text-field
                              v-model="user.name"
                              :counter="10"
                    ...
                    <ValidationProvider name="institution" rules="required" v-slot="{ errors, valid }">
                      <v-text-field
                    ...
                    <ValidationProvider name="password2" rules="required|min:8" v-slot="{ errors, valid }">
                      <v-text-field
                ...
                <v-card-actions>
                  ...
                  <v-spacer></v-spacer>
                  <v-btn color="primary darken-2" :disabled="invalid || !validated" @click="passes(handleSubmit)">
                    {{ $t('register') }}
                  </v-btn>
                </v-card-actions>
              </v-card>
